            ...
            <div>
                <div style={{height: "800px"}}>
                    <div className="frame-div" style={{ width: "20%" }}>
                        <InquireLeftPageContent operatorItems={operatorItems} showInquireDiv={uiOptions.showInquireDiv} dispatch={this.props.dispatch} />
                    </div>
                    <div className="frame-div" style={{ width: "60%" }}>
                        <InquireCenterPageContent activeRowIndex={uiOptions.activeRowIndex} activeColumnIndex={uiOptions.activeColumnIndex} canDeleteItem={uiOptions.canDeleteItem} canEditText={uiOptions.canEditText} userData={this.props.userData.present} dispatch={this.props.dispatch} />
                    </div>
